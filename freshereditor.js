	...
	(function ($) {
		...
		methods = {
		  ...
		  [
			...
			{
				name: 'FontSize',
				label: "<span style='font-weight:bold;'>A</span><span style='font-size:50%;'>A</span> <span class='caret'></span>",
			...
			{
				name: 'backcolor',
				label: "<div style='display:inline-block;width:15px;height:12px;background-color:#0000ff;'></div> <span class='caret'></span>",
